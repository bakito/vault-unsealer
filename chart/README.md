...
```console
helm install my-vault-unsealer oci://ghcr.io/bakito/helm-charts/vault-unsealer --version 0.4.1
```
...
helm install my-vault-unsealer bakito/vault-unsealer --version 0.4.1
```
